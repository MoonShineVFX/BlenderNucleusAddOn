...
<img width="1118" height="546" alt="AddOn" src="https://github.com/user-attachments/assets/9e181570-a501-4456-8141-9d6e029741cf" />
...
- 有修改的貼圖Save時才會上傳至Server，未修改的貼圖不會被重複上傳
- 若在已存在的USD檔中新增貼圖，Save時該貼圖也會被上傳至Server
- Login機制會由Nucleus server自動處理，與Add On無關
